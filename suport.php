...
<h2>Suport clienti - trimitere ticket</h2>
 <div class="w3-container w3-padding-32" id="contact">
    <p>Daca nu ai gasit rezolvarea problemei tale, foloseste formularul de mai jos si trimite-ne un ticket!</p>
    <form action="trimitere_ticket.php" method="post">
      <input class="w3-input w3-section" type="text" placeholder="Nume" required name="nume">
      <input class="w3-input w3-section" type="text" placeholder="Prenume" required name="prenume">
      <input class="w3-input w3-section" type="text" placeholder="Numar de telefon" required name="telefon">
      <input class="w3-input w3-section" type="text" placeholder="Mail" required name="mail">
      <input class="w3-input w3-section" type="text" placeholder="Titlul problemei" required name="problema">
      <input class="w3-input w3-section" type="text" placeholder="Explicarea problemei" required name="descriere">
      <button class="w3-button w3-black w3-section" type="submit">
        <i class="fa fa-paper-plane"></i> TRIMITE TICKET
      </button>
    </form>
  </div>
