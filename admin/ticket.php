...
<html>
<head>
<title>Gionee - Lista ticket</title>
...
<?php	
	...
	$sql = 'SELECT * FROM Ticket WHERE Ticket.nume LIKE :keyword OR Ticket.prenume LIKE :keyword ORDER BY Ticket.nume ASC';
...
<table class='tbl-qa'>
  <thead>
	<tr>
	  ...
	  <th class='table-header' width='10%'>Problema</th>
	  <th class='table-header' width='10%'>Descriere</th>
	</tr>
  </thead>
  <tbody id='table-body'>
	<?php
