...
<html>
<head>
<title>Gionee - Lista comenzi</title>
...
<ul class="sidenav">
  ...
  <li><a class="active" href="comenzi.php">Comenzi</a></li>
...
<?php	
	...
	$sql = 'SELECT * FROM Client WHERE Client.nume LIKE :keyword OR Client.prenume LIKE :keyword ORDER BY Client.nume ASC';
...
<table class='tbl-qa'>
  <thead>
	<tr>
	  ...
	  <th class='table-header' width='10%'>Prenume</th>
	  <th class='table-header' width='10%'>Telefon</th>
	  <th class='table-header' width='10%'>Mail</th>
	  <th class='table-header' width='10%'>Adresa de livrare</th>
	</tr>
  </thead>
  <tbody id='table-body'>
	<?php
