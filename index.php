...
<div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="mesaj_trimis.php" method="post">
      <div class="w3-section">      
        <label>Nume</label>
        <input class="w3-input" type="text" name="nume" required>
      </div>
      <div class="w3-section">      
      ...
      <div class="w3-section">      
        <label>Mesajul</label>
        <input class="w3-input" type="text" name="mesaj" required>
      </div>  
      <button type="submit" class="w3-button w3-right w3-theme">Trimite</button>
      </form>
    </div>
  </div>
</div>
